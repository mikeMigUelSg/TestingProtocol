...
#define S_FUNCTION_NAME BMSBalancingLogic_msf
#endif
...
false ) ; ssSetInputPortSampleTime ( S , 0 , 5.0 ) ; ssSetInputPortOffsetTime
...
false ) ; ssSetInputPortSampleTime ( S , 1 , 5.0 ) ; ssSetInputPortOffsetTime
...
false ) ; ssSetInputPortSampleTime ( S , 2 , 5.0 ) ; ssSetInputPortOffsetTime
...
false ) ; ssSetInputPortSampleTime ( S , 3 , 5.0 ) ; ssSetInputPortOffsetTime
( S , 3 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 1 ) ) return ; if ( !
ssSetOutputPortMatrixDimensions ( S , 0 , 1 , 96 ) ) return ;
...
#endif
} ssSetOutputPortSampleTime ( S , 0 , 5.0 ) ; ssSetOutputPortOffsetTime ( S ,
...
mr_BMSBalancingLogic_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_BMSBalancingLogic_MdlInfoRegFcn ( S , "BMSBalancingLogic" , & retVal ) ;
if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( nxoas2gjfbm ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { nxoas2gjfbm * dw = ( nxoas2gjfbm * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } bjd0wkxsam ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { nxoas2gjfbm * dw = ( nxoas2gjfbm * ) ssGetDWork ( S , 0 )
; real32_T const * i_cebvpcbp1q = ( real32_T * ) ssGetInputPortSignal ( S , 0
) ; real32_T const * i_dp3icoqurv = ( real32_T * ) ssGetInputPortSignal ( S ,
1 ) ; real32_T const * i_owyaaxflzk = ( real32_T * ) ssGetInputPortSignal ( S
, 2 ) ; real32_T const * i_bfjeehnrqx = ( real32_T * ) ssGetInputPortSignal ( S
, 3 ) ; boolean_T * o_o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S ,
0 ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) {
BMSBalancingLogic ( i_cebvpcbp1q , i_dp3icoqurv , i_owyaaxflzk , i_bfjeehnrqx
, o_o_o_B_2_1 , & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct
* S ) { nxoas2gjfbm * dw = ( nxoas2gjfbm * ) ssGetDWork ( S , 0 ) ;
jozn1uvmvd ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_BMSBalancingLogic_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_BMSBalancingLogic_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_BMSBalancingLogic_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
