...
MODEL                   = BMSController
MODULES                 = BMSController.c BMSController_capi.c
PRODUCT                 = BMSControllerlib.a
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2025a.app/bin/maca64" -lmex -lmwmathutil
