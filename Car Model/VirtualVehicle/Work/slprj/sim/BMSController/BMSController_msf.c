...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; p2t1vykwji ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; n3ldsg2m4a ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; boolean_T * o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_B_1_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_B_1_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_B_1_9 = ( boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_B_1_10 = ( boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_B_1_11 = ( boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ; boolean_T * o_B_1_12 = ( boolean_T * ) ssGetOutputPortSignal ( S , 11 ) ; boolean_T * o_B_1_13 = ( boolean_T * ) ssGetOutputPortSignal ( S , 12 ) ; real32_T const * i_dkgm30uxxx = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_mdwdu2qm31 = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_emp2vrce40 = ( real32_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_e4sutes4z2 = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const * i_nl11aqv5ym = ( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; real32_T const * i_kkpwbz1z2c = ( real32_T * ) ssGetInputPortSignal ( S , 5 ) ; if ( tid == 0 ) { BMSControllerTID0 ( & ( dw -> rtm ) , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , o_B_1_11 , o_B_1_12 , o_B_1_13 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; dhe0j1g5mvTID0 ( i_dkgm30uxxx , i_mdwdu2qm31 , i_emp2vrce40 , i_e4sutes4z2 , i_nl11aqv5ym , i_kkpwbz1z2c , & ( dw -> rtdw ) ) ; } if ( tid == 1 ) { BMSControllerTID1 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; dhe0j1g5mvTID1 ( ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 6 , 13 ) ; if ( ! ssSetNumInputPorts ( S , 6 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 96 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_SINGLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
( S , 5 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 13 ) ) return ; if ( !
...
ssSetOutputPortMatrixDimensions ( S , 12 , 1 , 96 ) ) return ;
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( prqjzwjjc0p ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } lftbpoqxym ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; boolean_T * o_B_1_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_B_1_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_B_1_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_B_1_9 = ( boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_B_1_10 = ( boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_B_1_11 = ( boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ; boolean_T * o_B_1_12 = ( boolean_T * ) ssGetOutputPortSignal ( S , 11 ) ; boolean_T * o_B_1_13 = ( boolean_T * ) ssGetOutputPortSignal ( S , 12 ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ) { BMSControllerTID0 ( & ( dw -> rtm ) , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , o_B_1_11 , o_B_1_12 , o_B_1_13 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } if ( ssIsSampleHit ( S , 1 , tid ) ) { BMSControllerTID1 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; real32_T const * i_dkgm30uxxx = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_mdwdu2qm31 = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_emp2vrce40 = ( real32_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_e4sutes4z2 = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const * i_nl11aqv5ym = ( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; real32_T const * i_kkpwbz1z2c = ( real32_T * ) ssGetInputPortSignal ( S , 5 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) { dhe0j1g5mvTID0 ( i_dkgm30uxxx , i_mdwdu2qm31 , i_emp2vrce40 , i_e4sutes4z2 , i_nl11aqv5ym , i_kkpwbz1z2c , & ( dw -> rtdw ) ) ; } if ( ssIsSampleHit ( S , 1 , tid ) ) { dhe0j1g5mvTID1 ( ) ; } return ; } static void mdlTerminate ( SimStruct * S ) { prqjzwjjc0p * dw = ( prqjzwjjc0p * ) ssGetDWork ( S , 0 ) ; g10dj1kimi ( & ( dw -> rtdw ) , & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_BMSController_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_BMSController_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss ,
...
mr_BMSController_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss ,
