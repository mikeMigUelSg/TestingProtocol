#ifndef BMSController_private_h_
#define BMSController_private_h_
#include "rtwtypes.h"
...
#define rtmIsSpecialSampleHit(rtm, sti, prom_sti, tid) ssIsSpecialSampleHit( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[sti], (rtm)->Timing.mdlref_GlobalTID[prom_sti], tid)
#endif
