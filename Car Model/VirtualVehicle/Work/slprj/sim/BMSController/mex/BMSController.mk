...
MAKECMD         = /Applications/MATLAB_R2025a.app/bin/maca64/gmake -j 10 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = BMSController
MODULES                 = BMSController_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/BMSController_msf.mexmaca64
MAKEFILE                = BMSController.mk
MATLAB_ROOT             = /Applications/MATLAB_R2025a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2025a.app
START_DIR               = /Users/miguelferreira/MATLAB/Projects/examples/VirtualVehicle2/VirtualVehicle/Work
S_FUNCTIONS_LIB         = $(START_DIR)/slprj/sim/_sharedutils/rtwshared.a
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
CLASSIC_INTERFACE       = 0
TGT_FCN_LIB             = ISO_C
MODELREFS               = BMSBalancingLogic BMSOut BMSCurrPowerLimCalc BMSSOCEstimation BMSStateMachine 
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
SHRLIBTARGET            = 1
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2025a.app/bin/maca64" -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lemlrt -lmx -lmex
...
MODELLIB                  = BMSController_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/BMSController/BMSControllerlib.a ../../../../slprj/sim/BMSBalancingLogic/BMSBalancingLogiclib.a ../../../../slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalclib.a ../../../../slprj/sim/BMSOut/BMSOutlib.a ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/BMSController/BMSControllerlib.a ../../../../slprj/sim/BMSBalancingLogic/BMSBalancingLogiclib.a ../../../../slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalclib.a ../../../../slprj/sim/BMSOut/BMSOutlib.a ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/BMSController/BMSControllerlib.a ../../../../slprj/sim/BMSBalancingLogic/BMSBalancingLogiclib.a ../../../../slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalclib.a ../../../../slprj/sim/BMSOut/BMSOutlib.a ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a -Wl,--end-group
endif
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/BMSStateMachine \
	-I$(START_DIR)/slprj/sim/BMSSOCEstimation \
	-I$(START_DIR)/slprj/sim/BMSOut \
	-I$(START_DIR)/slprj/sim/BMSCurrPowerLimCalc \
	-I$(START_DIR)/slprj/sim/BMSBalancingLogic \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/BMSController \
...
BMSController_msf.o : $(START_DIR)/slprj/sim/BMSController/BMSController_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/BMSController/BMSController_msf.c
