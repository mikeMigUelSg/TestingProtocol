...
#define S_FUNCTION_NAME BMSCurrPowerLimCalc_msf
#endif
...
real_T rtP__PlntBattNumCellPar2f2BatteryDCDC_sldd_ ; const char *
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP__PlntBattNumCellPar2f2BatteryDCDC_sldd_ ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } }
#endif
static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
ozx2hltu2vi * dw = ( ozx2hltu2vi * ) ssGetDWork ( S , 0 ) ; real32_T const *
i_b4lme33cv2 = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const
* i_lkc45qqj2d = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T *
o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2
= ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; if ( tid == 0 ) { BMSCurrPowerLimCalc ( i_b4lme33cv2 , i_lkc45qqj2d , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 2 , 6 ) ; if ( ! ssSetNumInputPorts ( S , 2 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 96 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_SINGLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
( S , 1 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 6 ) ) return ; if ( !
...
mr_BMSCurrPowerLimCalc_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_BMSCurrPowerLimCalc_MdlInfoRegFcn ( S , "BMSCurrPowerLimCalc" , & retVal )
; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ozx2hltu2vi ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ozx2hltu2vi * dw = ( ozx2hltu2vi * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } mmipgl5oaa ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , & ( dw -> rtm ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { ozx2hltu2vi * dw = ( ozx2hltu2vi * ) ssGetDWork ( S , 0 ) ; real32_T const * i_b4lme33cv2 = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_lkc45qqj2d = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; real32_T * o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ; real32_T * o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { BMSCurrPowerLimCalc ( i_b4lme33cv2 , i_lkc45qqj2d , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 ) ; } } static void mdlTerminate ( SimStruct * S ) { ozx2hltu2vi * dw = ( ozx2hltu2vi * ) ssGetDWork ( S , 0 ) ; du2aze3q0u ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_BMSCurrPowerLimCalc_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_BMSCurrPowerLimCalc_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_BMSCurrPowerLimCalc_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
