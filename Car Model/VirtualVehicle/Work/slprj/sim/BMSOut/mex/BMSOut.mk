...
MODEL                   = BMSOut
MODULES                 = BMSOut_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/BMSOut_msf.mexmaca64
MAKEFILE                = BMSOut.mk
...
MODELLIB                  = BMSOut_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/BMSOut/BMSOutlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/BMSOut/BMSOutlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/BMSOut/BMSOutlib.a -Wl,--end-group
endif
...
BMSOut_msf.o : $(START_DIR)/slprj/sim/BMSOut/BMSOut_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/BMSOut/BMSOut_msf.c
