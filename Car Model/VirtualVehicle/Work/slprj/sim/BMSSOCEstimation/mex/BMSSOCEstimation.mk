...
MODULES                 = BMSSOCEstimation_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/BMSSOCEstimation_msf.mexmaca64
MAKEFILE                = BMSSOCEstimation.mk
...
MODELLIB                  = BMSSOCEstimation_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/BMSSOCEstimation/BMSSOCEstimationlib.a -Wl,--end-group
endif
...
BMSSOCEstimation_msf.o : $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_msf.c
