...
MODULES                 = BMSStateMachine_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/BMSStateMachine_msf.mexmaca64
MAKEFILE                = BMSStateMachine.mk
...
MODELLIB                  = BMSStateMachine_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/BMSStateMachine/BMSStateMachinelib.a -Wl,--end-group
endif
...
BMSStateMachine_msf.o : $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_msf.c
