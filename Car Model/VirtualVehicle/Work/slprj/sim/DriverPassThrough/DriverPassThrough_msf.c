...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( am5nrfreizz ) ) )
...
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { DriverPassThrough ( i_frrxbql4f5
, o_B_1_1 ) ; } } static void mdlTerminate ( SimStruct * S ) { am5nrfreizz *
dw = ( am5nrfreizz * ) ssGetDWork ( S , 0 ) ; labuig2vc2 ( & ( dw -> rtm ) )
; return ; }
...
mr_DriverPassThrough_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_DriverPassThrough_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
