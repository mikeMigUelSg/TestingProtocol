...
MODEL                   = DriverPassThrough
MODULES                 = DriverPassThrough_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/DriverPassThrough_msf.mexmaca64
...
MODELLIB                  = DriverPassThrough_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/DriverPassThrough/DriverPassThroughlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/DriverPassThrough/DriverPassThroughlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/DriverPassThrough/DriverPassThroughlib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/DriverPassThrough \
...
DriverPassThrough_msf.o : $(START_DIR)/slprj/sim/DriverPassThrough/DriverPassThrough_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/DriverPassThrough/DriverPassThrough_msf.c
