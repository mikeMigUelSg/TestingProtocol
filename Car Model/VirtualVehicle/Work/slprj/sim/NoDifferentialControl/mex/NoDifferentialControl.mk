...
MODEL                   = NoDifferentialControl
MODULES                 = NoDifferentialControl_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/NoDifferentialControl_msf.mexmaca64
MAKEFILE                = NoDifferentialControl.mk
...
MODELLIB                  = NoDifferentialControl_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/NoDifferentialControl/NoDifferentialControllib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/NoDifferentialControl/NoDifferentialControllib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/NoDifferentialControl/NoDifferentialControllib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/NoDifferentialControl \
...
NoDifferentialControl_msf.o : $(START_DIR)/slprj/sim/NoDifferentialControl/NoDifferentialControl_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/NoDifferentialControl/NoDifferentialControl_msf.c
