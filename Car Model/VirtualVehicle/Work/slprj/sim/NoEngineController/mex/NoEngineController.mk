...
MODEL                   = NoEngineController
MODULES                 = NoEngineController_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/NoEngineController_msf.mexmaca64
MAKEFILE                = NoEngineController.mk
...
MODELLIB                  = NoEngineController_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/NoEngineController/NoEngineControllerlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/NoEngineController/NoEngineControllerlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/NoEngineController/NoEngineControllerlib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/NoEngineController \
...
NoEngineController_msf.o : $(START_DIR)/slprj/sim/NoEngineController/NoEngineController_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/NoEngineController/NoEngineController_msf.c
