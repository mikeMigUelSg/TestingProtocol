...
MODEL                   = NoThermalControl
MODULES                 = NoThermalControl_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/NoThermalControl_msf.mexmaca64
MAKEFILE                = NoThermalControl.mk
...
MODELLIB                  = NoThermalControl_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/NoThermalControl/NoThermalControllib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/NoThermalControl/NoThermalControllib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/NoThermalControl/NoThermalControllib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/NoThermalControl \
...
NoThermalControl_msf.o : $(START_DIR)/slprj/sim/NoThermalControl/NoThermalControl_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/NoThermalControl/NoThermalControl_msf.c
