...
{ 1022429052U , 3177599843U , 221525850U , 2334923404U } , &
...
. mmi , njmlsg0bqs -> DataMapInfo . systemTid ) ; rtwCAPI_SetGlobalTIDMap ( njmlsg0bqs -> DataMapInfo . mmi , & njmlsg0bqs -> Timing . mdlref_GlobalTID [ 0 ] ) ; }
#else
#ifdef __cplusplus
extern "C" {
#endif
