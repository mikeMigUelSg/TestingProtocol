...
MODEL                   = rtwshared
MODULES                 = rt_nonfinite.c look1_iflf_binlcpw.c sumColumnB_fvjKjn1f.c look1_binlcapw.c look2_binlcapw.c
PRODUCT                 = rtwshared.a
MAKEFILE                = 
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  OPTS="-DNRT -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
